...
?>
<div id="footer-main-row" class="grid-row">
  ...
  <div class="grid-item no-gutter grid-row">
    ...
    <div id="footer-row-a" class="grid-item item-s-auto item-m-12 no-gutter grid-row">
    ...
    <div id="footer-row-b" class="offset-m-1 grid-item no-gutter grid-row">
