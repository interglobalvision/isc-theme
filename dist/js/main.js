  ...
  _createClass(Site, [{
    ...
    */
        ...
        var args = {
          ...
          on: {
            init: function init(swiper) {
              (0, _jquery2.default)('#featured-albums-swiper').on({
                mousemove: function mousemove(e) {
                  if (event.pageX < _this.windowWidth / 2) {
                    (0, _jquery2.default)(this).removeClass('mouse-right').addClass('mouse-left');
                  } else {
                    (0, _jquery2.default)(this).removeClass('mouse-left').addClass('mouse-right');
                  }
                },
    ...
    value: function setupOverlaySwiper() {
      ...
      if ((0, _jquery2.default)('.overlay-gallery-slide').length && this.windowWidth >= this.landscapeThreshold) {
        var args = {
          slidesPerView: 'auto',
          loop: true,
          loopedSlides: 10,
