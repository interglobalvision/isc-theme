...
exports.bindModuleMethods = exports.extend = exports.isObject = exports.getTranslate = exports.now = exports.nextTick = exports.deleteProps = undefined;
...
var _mailchimp = __webpack_require__(33);
...
var Site = function () {
  ...
  _createClass(Site, [{
    ...
    key: 'initWelcomePanel',
    value: function initWelcomePanel() {
      var welcomeCookie = _jsCookie2.default.get('wc');

      if (!welcomeCookie) {
        (0, _jquery2.default)('body').addClass('welcome-open');
      }

      (0, _jquery2.default)('.close-welcome').on('click', function () {
        (0, _jquery2.default)('body').removeClass('welcome-open');
        _jsCookie2.default.set('wc', 'true');
      });
    }
  }, {
    key: 'bindMobileNav',
    value: function bindMobileNav() {
      (0, _jquery2.default)('.toggle-nav').on('click', function () {
    ...
    value: function bindOverlayGallery() {
      (0, _jquery2.default)('.toggle-gallery').off().on('click', function () {
    ...
    */
    ...
    value: function updateMetaData(data, title, url) {
      var $meta = (0, _jquery2.default)(data).filter('meta');

      document.title = title;

      _jquery2.default.each($meta, function (index, el) {
        var prop = (0, _jquery2.default)(el).attr('property');
        var content = (0, _jquery2.default)(el).attr('content');
        if (prop) {
          if (prop.startsWith('og:')) {
            (0, _jquery2.default)('meta[property="' + prop + '"]').attr('content', content);
          }
        }
      });
    }
    ...
    value: function replaceContent(href, context, isPop) {
      ...
      (0, _jquery2.default)('body').addClass('loading').removeClass('welcome-open mobile-nav-open gallery-open search-open playlist-open');
      this.destroyOverlaySwiper();

      _jquery2.default.ajax({
        url: href,
        success: function success(data) {
          var content = (0, _jquery2.default)(data).find('#main-content').html();
    ...
    key: 'replaceOverlayGallery',
    value: function replaceOverlayGallery(data) {
      var $overlaySlides = (0, _jquery2.default)(data).find('.overlay-gallery-slide');

      if ($overlaySlides.length) {
        (0, _jquery2.default)('#overlay-gallery-swiper-wrapper').html($overlaySlides);
        this.setupOverlaySwiper();
      }
    }
  }, {
    ...
    value: function setupOverlaySwiper() {
      ...
      if ((0, _jquery2.default)('.overlay-gallery-slide').length && (0, _jquery2.default)(window).width() >= this.landscapeThreshold) {
        var args = {
          slidesPerView: 'auto',
          loop: true,
          loopedSlides: 10,
    ...
    key: 'destroyOverlaySwiper',
    value: function destroyOverlaySwiper() {
...
var _virtual = __webpack_require__(9);
...
var _mousewheel = __webpack_require__(12);
...
var _hashNavigation = __webpack_require__(22);
...
var _autoplay = __webpack_require__(23);
...
var _effectFade = __webpack_require__(24);
...
var _effectCube = __webpack_require__(25);
...
var _effectFlip = __webpack_require__(26);
...
var _effectCoverflow = __webpack_require__(27);
...
var _getSupport = __webpack_require__(5);

var _getDevice = __webpack_require__(29);

var _getBrowser = __webpack_require__(30);
...
var Swiper = /*#__PURE__*/function () {
  function Swiper() {
    ...
    if (el && el.shadowRoot && el.shadowRoot.querySelector) {
      $wrapperEl = (0, _dom2.default)(el.shadowRoot.querySelector("." + swiper.params.wrapperClass)); // Children needs to return slot items
...
var Player = function () {
  ...
  _createClass(Player, [{
    ...
    */
    ...
    key: 'handleTrack',
    value: function handleTrack(response) {
    ...
    value: function setDuration() {
      var duration = this.millisToMinutesAndSeconds(this.currentTrack.duration);
...
var Mailchimp = function () {
  function Mailchimp() {
    ...
    (0, _jquery2.default)(window).on('ajaxSuccess', this.onReady); // Bind ajaxSuccess (custom event, comes from Ajaxy)
  ...
  _createClass(Mailchimp, [{
    ...
    value: function submitForm(e) {
      ...
      _jquery2.default.each(dataArray, function (index, item) {
